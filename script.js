...
const msgTitle_long =
  "Exploring Nature's Trails: The Ultimate Guide to Hiking Adventures, Tips for Beginners, and Discovering Breathtaking Landscapes Around the World";
const msgTitle_medium =
  "Hiking the Great Outdoors: A Journey Through Nature's Wonders";
...
titleOptions.forEach((radio) => {
  radio.addEventListener("click", function () {
    if (this.value === "long") {
      ...
      title.textContent = msgTitle_medium;
    } else if (this.value === "short") {
      title.textContent = msgTitle_short;
    }
  });
});
